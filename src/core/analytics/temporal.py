"""
Agregações temporais: granularidade, evolução e concentração por período.
Usadas por qualquer análise que tenha uma data de referência.
"""
...
from config.settings import COLUNA_DATA_PADRAO, DIAS_SEMANA


# ---------------------------------------------------------------------
# Granularidade e rótulos
# ---------------------------------------------------------------------
